...
function Contact() {
  return (
    <div name='contact' className='w-screen h-full bg-[#FEFEFE] '>
        <div className='md:max-w-[1190px]  mx-auto my-4 py-8 px-5 h-full bg-[#FEFEFE] shadow-md '>
                 ...
                 <div className=' w-full  p-3 rounded-lg shadow-sm  border border-slate-100 -z-10'>
                  <form action="https://getform.io/f/lbkommqb" method='POST' className=' flex flex-col'>
                    <div className='flex flex-col md:flex-row md:items-center md:justify-evenly gap-3 '>         
                       <input type="text" name='name' required placeholder='Enter your name' className='w-full p-2 rounded-lg border border-zinc-300 outline-slate-400'/>
                       <input type="text" name='surname' required placeholder='Enter your surname' className='w-full p-2 rounded-lg border border-zinc-300 outline-slate-400'/>
                    </div>
                    <div className='flex flex-col md:flex-row md:items-center md:justify-evenly gap-3 mt-3 mb-3'>
                       <input type="email" name='email' required placeholder='Enter email address' className='w-full p-2 rounded-lg border border-zinc-300 outline-slate-400' />
                       <input type="number" name='number' required placeholder='Enter phone number' className='w-full p-2 rounded-lg border border-zinc-300 outline-slate-400'/>
                    </div>
                    <textarea name="message"  id="" cols="30" rows="5" required placeholder='Enter your message' className='w-full rounded-lg p-2 border border-zinc-300 outline-slate-400'></textarea>
