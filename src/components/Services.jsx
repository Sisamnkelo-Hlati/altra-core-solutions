...
function Services() {
  return (
    <div name='services' className='w-full h-full bg-zinc-800'>
        <div className='max-w-[1190px] w-full mx-auto p-10 h-full '>
          <motion.div
           ...
           className='md:flex md:flex-col md:items-center md:max-w-[600px] md:mx-auto'>
             <h2 className='mb-3 text-3xl text-zinc-600 font-bold tracking-wider'>Our <span className='text-[#0504aa]'>Services</span></h2>
             <p className='leading-7 w-full  tracking-wide mb-3 text-base text-zinc-400'>AltraCore Solutions offers different kinds of services that meet our client's needs, the services
         ...
         <div className=' bg-zinc-700 mb-11 duration-500 mt-5 flex items-center flex-col md:mb-5 shadow-md   p-4  rounded-md border border-gray-200 '>
          ...
          <div className='bg-zinc-700 duration-500 mt-5 flex items-center flex-col md:mb-5 shadow-md  p-4 rounded-md border border-gray-200 '>
            <div className='w-32 h-32 relative top-[-50px]  bg-blue-100 rounded-full flex justify-center items-center mb-2  border border-blue-200'>
