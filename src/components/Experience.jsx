...
function Experience() {
  ...
  return (
    <div className='w-auto h-full bg-[#f5f5ff]'>
        <div className='max-w-[1190px] w-full mx-auto py-3   '>
        <div
                
                  className='h-[350px] md:h-[180px] relative  mx-5 rounded-md bg-[#ccccfe]'>
                  <ScrollTrigger onEnter={() => setTriggerOnScroll(true)} onExit={() => setTriggerOnScroll(false)}> 
                   <div className='absolute  top-0 left-0 -z-0 w-full px-3 grid sm:grid-cols-2 md:grid-cols-3 gap-3 py-10 md:py-11 '>
                    <div className=' bg-[#E6E6FE] w-full mr-5 flex flex-col items-center border border-[#a09e9e] p-3 rounded-md'>
                    ...
                    <div className=' bg-[#E6E6FE] w-full mr-5 flex flex-col items-center border border-[#cecccc] p-3 rounded-md'>
