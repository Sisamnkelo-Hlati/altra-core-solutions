    ...
    <div className=' absolute top-0 bg-zinc-900/80  w-full h-[50%] md:h-[47%]'/>
      < div
       ...
       <h1 className='text-white font-bold text-2xl md:text-7xl  px-5 pb-2 tracking-wide md:tracking-wider mb-3  md:w-full '>  <span className=''>ALTRA</span>CORE SOLUTIONS</h1>
        <h2 className='text-zinc-200 mt-16  py-2 px-5 md:px-2 text-base md:pl-7  md:text-2xl leading-7 tracking-wide md:max-w-[900px] md:mx-auto'>We offer constructive solutions to the satisfaction of your construction, cleaning and logistics service needs </h2>
