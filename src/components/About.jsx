...
function About() {
  ...
  return (
    <div name='about' className='w-auto h-full bg-[#f5f5ff]'>
        <div className='max-w-[1190px] w-full mx-auto py-3 px-5  '>
            ...
            <div className='grid md:grid-cols-2 gap-2 md:gap-7  bg-[#E6E6FE] rounded-md mb-2 px-2'>
            ...
            <div className=' h-[200px] md:h-[406px] flex items-center justify-center  '>
              ...
              <div >
                 ...
                 <p
                  ...
                  className='leading-7  tracking-wide mb-2 text-zinc-500 text-base ml-2'>
